  ...
  created() {
    ...
    if (vm.fields) {
      ...
      for (let k in fields) {
        ...
        if (field.label == undefined) col.title = ''
    ...
    if (vm.details) {
      ...
      const col = {
        ...
        data: null,
        defaultContent: vm.details.icons || '<span class="details-plus btn btn-success btn-xs" title="Show details"><i class="fa fa-plus"></i></span><span class="details-minus btn btn-danger btn-xs" title="Hide details"><i class="fa fa-minus"></i></span>'
      }
